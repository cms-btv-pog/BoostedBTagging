...
patEventContentNoCleaning.append('keep recoTracks_refittedStandAloneMuons_*_*')
patEventContentNoCleaning.append('keep recoTracks_tevMuons_*_*')
patEventContentNoCleaning.append('keep *_*_muCorrData_*')
